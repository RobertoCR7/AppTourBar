...
class GaleriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create galerium" do
    assert_difference('Galerium.count') do
      post galeria_url, params: { galerium: { descripcion: @galerium.descripcion, image_url: @galerium.image_url, titulo: @galerium.titulo } }
    end
  ...
  test "should update galerium" do
    patch galerium_url(@galerium), params: { galerium: { descripcion: @galerium.descripcion, image_url: @galerium.image_url, titulo: @galerium.titulo } }
