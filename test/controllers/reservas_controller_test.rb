...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { mesa: @reserva.mesa, nombre: @reserva.nombre, reserva: @reserva.reserva } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { mesa: @reserva.mesa, nombre: @reserva.nombre, reserva: @reserva.reserva } }
