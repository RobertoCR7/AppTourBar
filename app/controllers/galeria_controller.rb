class GaleriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @galerium.save
        format.html { redirect_to @galerium, notice: 'Imagen creada correctamente.' }
  ...
  def update
    respond_to do |format|
      if @galerium.update(galerium_params)
        format.html { redirect_to @galerium, notice: 'Imagen actualizada correctamente.' }
  ...
  def destroy
    @galerium.destroy
    respond_to do |format|
      format.html { redirect_to galeria_url, notice: 'Imagen eliminada correctamente.' }
  ...
  private
    ...
    def galerium_params
      params.require(:galerium).permit(:titulo, :descripcion, :image, :remove_image)
    end
end
